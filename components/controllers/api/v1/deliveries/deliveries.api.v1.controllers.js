...
// query by product minimium weight
router.route('/weight/min')
  .get(
    (req, res, next) => handler(getValidator, req, res, next, validations['getByWeight']),
    (req, res, next) => responses(deliveriesCommonServices.findByMinWeight, req, res, next))
